...
| `run-ledger.json` | One entry per node/run: lineage, stage, scores, and (where available) engine telemetry — the dial, novelty/grounding, and breeding stats behind each result. |
